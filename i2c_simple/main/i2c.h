...
esp_err_t i2c_master_write_read_device_io(i2c_port_t i2c_num, uint8_t device_address,
                                       const uint8_t* write_buffer,uint8_t device_address1, size_t write_size,
                                       uint8_t* read_buffer, size_t read_size,
                                       TickType_t ticks_to_wait);                                       
