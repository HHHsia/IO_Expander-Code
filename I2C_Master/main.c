...
{	
		...
		printf("chip ID : %X\n", byteData);
		printf("End of I2C Read Chip ID function\n");
		return byteData;
}
uint8_t I2C_Write(uint8_t INDEX , uint8_t value)//INDEX:register address , value:what value we want to write
{	
		uint8_t byteData;
...
int32_t main(void)
{
    ...
    printf("Reading Chip ID test OK.\n");
		...
		printf("\ninput value:");
		scanf("%d",&value);
		I2C_Write(register_address , value);
		}
