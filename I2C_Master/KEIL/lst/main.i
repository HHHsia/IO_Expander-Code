...
void I2C0_Init(void)
{
    ...
    I2C_Open(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 150000);
...
{	
		...
		I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)),1, 0, 1, 0);	
		while(!((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON & (1ul << 3)));	
		
		
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = 0x40; 
		I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)),0, 0, 1, 0);	
		while(!((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON & (1ul << 3))); 

		
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = 0x2E;
		I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)),0, 0, 1, 0);	
		while(!((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON & (1ul << 3)));	
		...
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = (0x41);
		I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)),0, 0, 1, 0);	
		while(!((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON & (1ul << 3)));	
		
		
		
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = 0xFF;
		I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)),0, 0, 1, 0);   
		while(!((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON & (1ul << 3)));	
		byteData = ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT;
		I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)),0, 1, 1, 0);   
...
uint8_t I2C_Write(uint8_t INDEX , uint8_t value)
{	
		uint8_t byteData;
		...
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = INDEX;
		I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)),0, 0, 1, 0);
		while(!((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON & (1ul << 3)));	
		
		
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = value;	
		I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)),0, 0, 1, 0);    	
		while(!((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON & (1ul << 3)));	
